...
<div id="wrap">
	<!-- header -->
	<div id="header">
		<h1><a href="/tlj_mobil/index.do" id="top_logo" class="sp h_logo" tabindex="1" style="text-align:center !important;">TLJ</a></h1>
	</div>
	<!-- //header -->
	<!-- container -->
	<div id="container">
	<!-- content -->
		<div id="content">
			...
			<div class="position_a">
				<div class="find_info">
					<a target="_blank" href="https://nid.naver.com/mobile/user/global/idInquiry.nhn?lang=ko_KR" onclick="try{nclks('log.searchid',this,event)}catch(e){}">아이디 찾기</a> <span class="bar">|</span> <a target="_blank" href="https://nid.naver.com/mobile/user/global/pwInquiry.nhn?lang=ko_KR" onclick="try{nclks('log.searchpass',this,event)}catch(e){}">비밀번호 찾기</a> <span class="bar">|</span> <a target="_blank" href="/tlj_mobil/TljJoin.do">회원가입</a></div>
			</div>
		</div>
	</div>
